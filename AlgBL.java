...
public class AlgBL {
     ...
     * @return
     */
    public ArrayList<Integer> busquedaLocal(ArrayList<ArrayList<Integer>> matrizCTR, ArrayList<ArrayList<Integer>> matrizDOM,
...
//        MostrarDatos mostrar = new MostrarDatos();//QUITAR
        ...
        while (iter < 10000 && (coste_sol_generada >= coste_sol_anterior) && (!entorno_completo)) {
            ...
            int i = matrizDOM.get(r_frec).indexOf(frec_elegida);//PUEDE PROVOCAR FUERA DE RANGO EN ALGUN CASO, evito hacer un for y recorrer todo ese vector
